...
![结构 / Structure](./2021-10-01-pi-server-1633066843000.assets/1633067238450eSkTFTi2.jpeg)
...
![使用SD Card Formatter格式化SD卡 / Using SD Card Formatter to Format SD Card](./2021-10-01-pi-server-1633066843000.assets/1633067238461yjfCT3GH.png)


![格式化完成后，分区合二为一，显示真实容量 / After formatting, the partitions are combined into one, showing the real capacity](./2021-10-01-pi-server-1633066843000.assets/1633067238459yy8e3jiw.png)
...
![下载镜像 / Download Image](./2021-10-01-pi-server-1633066843000.assets/1633067238461ThBcpbeQ.png)

点击页面中download now后， 下载得到的文件为ubuntu-20.04.3-preinstalled-server-arm64+raspi.img



![ubuntu-20.04.3-preinstalled-server-arm64+raspi.img](./2021-10-01-pi-server-1633066843000.assets/1633067238550pr71MWDD.png)
...
![下载 / Download](./2021-10-01-pi-server-1633066843000.assets/1633067238460tDrMwx78.png)
...
![按自己的系统，选择自己需要下载的版本 / Choose the version you need to download according to your own system](./2021-10-01-pi-server-1633066843000.assets/1633067238705M2b8hWKS.png)

打开 Etcher , 选择镜像文件， 选择SD卡 , 开始烧录

![开始烧录 / Start Burning](./2021-10-01-pi-server-1633066843000.assets/163306723902278ntpzzK.png)
...
![查看安装了ubuntu的树莓派被分配的ip / Check the IP assigned to the Raspberry Pi that has installed Ubuntu](./2021-10-01-pi-server-1633066843000.assets/16330672384595THWTAWZ.png)

## 使用SSH登录树莓派服务器

![使用SSH登录树莓派服务器 / Use SSH to Log in to the Raspberry Pi Server](./2021-10-01-pi-server-1633066843000.assets/1633067238520AAP6sH4W.png)
...
![修改密码并重新登录 / Change Password and Log in Again](./2021-10-01-pi-server-1633066843000.assets/1633067239035w43SKNRX.png)
...
![服务端和客户端 / Server and Client](./2021-10-01-pi-server-1633066843000.assets/1633067238512Mj3MmBzx.png)
...
![修改服务端配置文件 frps.ini / Modify the server configuration file frps.ini](./2021-10-01-pi-server-1633066843000.assets/1633067239301Yzkk2mzD.png)
...
![开启程序，运行成功 / Start the program, run successfully](./2021-10-01-pi-server-1633066843000.assets/1633067239183TEXNnYF8.png)
...
![脚本正在运行中… / The script is running...](./2021-10-01-pi-server-1633066843000.assets/1633067239091KwNxktFy.png)
...
![](./2021-10-01-pi-server-1633066843000.assets/1633067239194E7K5wsiE.png)

- 使用浏览器从公网访问树莓派，验证内网穿透是否成功

  

![内网穿透成功 / Intranet Penetration Successful](./2021-10-01-pi-server-1633066843000.assets/1633067239241fpbGMSds.png)
...
![架构 / Architecture](./2021-10-01-pi-server-1633066843000.assets/1633067238656yym0n7K3.png)

使用ARMv8版本的稳定版Node.js

![使用ARMv8版本的稳定版Node.js / Use the Stable Version of Node.js for ARMv8](./2021-10-01-pi-server-1633066843000.assets/1633067239296WYzGbHcX.png)
...
![将Node.js添加到系统变量 / Add Node.js to System Variables](./2021-10-01-pi-server-1633066843000.assets/1633067239542M6rDSx6f.png)
...
![安装http-server服务 / Install http-server Service](./2021-10-01-pi-server-1633066843000.assets/1633067239314E2RkyMmh.png)
...
![pm2守护frpc和http-server服务成功 / pm2 Successfully Daemonizes frpc and http-server Services](./2021-10-01-pi-server-1633066843000.assets/1633067239590etMQaWEY.png)

访问 https://frp.v2fy.com

![页面显示 / Page Display](./2021-10-01-pi-server-1633066843000.assets/1633067239853MZEBxdne.png)

![文件内容访问成功 / File Content Access Successful](./2021-10-01-pi-server-1633066843000.assets/1633067239216BEt00mCX.png)
...
![在frpc.ini内添加ssh配置 / Add ssh Configuration in frpc.ini](./2021-10-01-pi-server-1633066843000.assets/16330672395672jNxSG7h.png)
...
![登录成功 / Login Successful](./2021-10-01-pi-server-1633066843000.assets/1633067239416kDAkBXGy.png)
...
![命令执行成功 / Command executed successfully](./2021-10-01-pi-server-1633066843000.assets/1633067240334Yhi7dna7.png)

为了验证开机自启，是否确实设置成功，我拔掉了树莓派的电源，果然http服务不可用了



![image.png](./2021-10-01-pi-server-1633066843000.assets/16330672394420d4cre35.png)
...
![可以访问了 / Can be accessed](./2021-10-01-pi-server-1633066843000.assets/1633067239089AkkadTPa.png)


![自动恢复进程 / Automatically recover the process](./2021-10-01-pi-server-1633066843000.assets/1633067239093rdE7esWK.png)
...
sudo fdisk -l
```
![U盘识别成功 / USB drive recognized successfully](./2021-10-01-pi-server-1633066843000.assets/1633067239437XpNPMQPM.png)
...
![访问扩容的U盘空间 / Access the expanded USB drive space](./2021-10-01-pi-server-1633066843000.assets/1633067239322KaCDip7B.png)
...
![web文件夹 / web folder](./2021-10-01-pi-server-1633066843000.assets/16330672398552H8STz6x.png)

再次查看`https://frp.v2fy.com`, 通过`https://frp.v2fy.com/sda1` 可以访问U盘里所有的文件
![frp.v2fy.com](./2021-10-01-pi-server-1633066843000.assets/1633067239281H34i2PkQ.png)

...
```
![创建 volume 持久化 Redis 缓存](./2021-10-20-rsshub-pi-1634690989000.assets/1634691008918t8rnYMYi.png)
...
```
![服务创建成功](./2021-10-20-rsshub-pi-1634690989000.assets/1634691008930eDa2R1xd.png)


- 访问树莓派ip的1200端口

![访问树莓派ip的1200端口](./2021-10-20-rsshub-pi-1634690989000.assets/1634691008924DAGzDrhk.png)
...
![映射成功](./2021-10-20-rsshub-pi-1634690989000.assets/1634691008963mTxK3TnP.png)


如果我们将子域名rsshub.v2fy.com 解析到外网主机ip, 访问 http://frp.v2fy.com:1200 和 http://rsshub.v2fy.com:1200 的效果是相同的

![rsshub-v2fy-com-1200](./2021-10-20-rsshub-pi-1634690989000.assets/1634691009049KCxtCRAQ.png)
...
![查看文档](./2021-10-20-rsshub-pi-1634690989000.assets/1634691009077thFH0iS3.png)


- 查看生成微博RSS的文档

![查看生成微博RSS的文档](./2021-10-20-rsshub-pi-1634690989000.assets/1634691009277M8mYZK0H.png)

- 查看id

![查看李子柒id](./2021-10-20-rsshub-pi-1634690989000.assets/1634691009721KNz5KR8T.png)


按照以上规则，李子柒的RSS为： http://rsshub.v2fy.com:1200/weibo/user/2970452952


![李子柒RSS](./2021-10-20-rsshub-pi-1634690989000.assets/1634691009796sb7Y56Rj.png)

## 通过RSS订阅地址，获取李子柒的最新微博信息，展示到Github主页上

![获取李子柒的最新微博信息](./2021-10-20-rsshub-pi-1634690989000.assets/1634691010016h832fhw5.png)


RSShub本质是一个为各类网页生成RSS信息的爬虫集合，我们可以通过阅读RSSHub的文档，获得各类知名网站的RSS信息。

![各种订阅](./2021-10-20-rsshub-pi-1634690989000.assets/1634691010370GHDaz8xw.png)
